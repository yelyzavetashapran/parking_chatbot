...
def ask_next_question(step):
    field = RESERVATION_FIELDS[step]
    print("Bot:", RESERVATION_QUESTIONS[field])
        ...
        try:
            ...
            if state == "qa":
                ...
                if any(trigger in user_input_lower for trigger in RESERVATION_TRIGGERS):
                    ...
                    reservation_data, temp_proposal, current_step = reset_reservation_state()

                    print("Bot: Sure! Let's make a parking reservation.")
                    ask_next_question(current_step)
                    continue
